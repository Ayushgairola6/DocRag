...
// top-10 left-10 md:right-10 
    return (<>
        ...
        <div className="absolute top-5 right-5  z-[1] space-grotesk w-auto md:w-fit ">
            ...
            <section className={`${isVisible ? "h-auto opacity-100 py-5 px-4" : "h-0 opacity-0 py-0 px-0"} bg-gradient-to-br from-gray-50 to-gray-100 text-black    overflow-hidden transition-all duration-300 rounded-lg mt-3 flex items-start justify-center gap-1  flex-col border border-black/40 relative `}>
                ...
                <span className='flex items-center ju-fy-between w-full hover:py-1 hover:px-1   gap-3 flex-row-reverse cursor-pointer text-xs md:text-sm hover:text-lg transition-all duration-300'>
