    ...
    return (<>
        <div className="z-[1] relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
                <h2 className="bai-jamjuree-semibold text-3xl md:text-4xl mb-4">Hear From Our Users</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Card 1 */}
                <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-300 hover:shadow-lg transition-all duration-300 shadow-md">
