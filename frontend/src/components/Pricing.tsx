        ...
        <div className="relative py-20 px-4 sm:px-6 z-[1] overflow-hidden bg-gray-50">
            ...
            <div className="max-w-4xl mx-auto text-center mb-16 relative">
                <h2 className="text-3xl sm:text-4xl bai-jamjuree-medium mb-4">
                    Simple, <span className="bg-clip-text text-transparent bg-gradient-to-r from-black to-purple-600">Transparent</span> Pricing
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div className="group relative p-8 bg-white/90 backdrop-blur-sm rounded-xl border border-gray-200/80 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 ">
                    ...
                    <ul className="space-y-4 mb-8 space-grotesk text-gray-700">
                ...
                <div className="group relative p-8 bg-white/90 backdrop-blur-sm rounded-xl border-2 border-purple-500/60 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 transform ">
                    ...
                    <button className="w-full py-3 px-6 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white bai-jamjuree-medium hover:opacity-90 transition-opacity cursor-pointer">
                        Start Free Trial
                    </button>
                </div>
